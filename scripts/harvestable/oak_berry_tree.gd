...
func setup_loot_table() -> void:
	var berry_table = LootTable.new()
	berry_table.add_entry("berry", 1, 3, 0.9)
	stage_loot_tables[1] = berry_table
...
func update_stage() -> void:
	...
	match stage:
		1:
			...
			sprite.texture.region = Rect2(48, 160, 48, 48)
			sprite.offset = Vector2(-7, -23)
		2:
			sprite.texture.region = Rect2(96, 160, 48, 48)
			sprite.offset = Vector2(-7, -23)
		3:
