...
func _ready():
	stages = {
		...
		Stage.SEEDED: PlantStage.new({
			...
			"texture_atlas": ItemDatabase.get_sprite_texture("onion_seed"),
		...
		Stage.SPROUTING: PlantStage.new({
			...
			"growth_time": 15.0,
			"growth_randomness": 100.0,
			"texture_atlas": ItemDatabase.get_sprite_texture("onion_sprout"),
			"sprite_offset": Vector2(0, -4),
			"one_hit": true,
			"require_water": false,
		...
		Stage.GROWING: PlantStage.new({
			...
			"health": 0.1,
			"growth_time": 15.0,
			"growth_randomness": 120.0,
			"texture_atlas": ItemDatabase.get_sprite_texture("onion_growing"),
			"sprite_offset": Vector2(0, -4),
			"one_hit": true,
			"require_water": false,
		...
		Stage.FLOWERING: PlantStage.new({
			...
			"health": 0.1,
			"growth_time": 35.0,
			"growth_randomness": 60.0,
			"texture_atlas": ItemDatabase.get_sprite_texture("onion_flowering"),
			"sprite_offset": Vector2(0, -4),
			"one_hit": true,
			"require_water": false,
		...
		Stage.RIPE: PlantStage.new({
			...
			"health": 0.1,
			"growth_time": 180.0,
			"growth_randomness": 300.0,
			"texture_atlas": ItemDatabase.get_sprite_texture("onion_ripe"),
			"sprite_offset": Vector2(0, -4),
			"one_hit": true,
			"require_water": false,
...
func setup_loot_table(stage: Stage) -> LootTable:
	...
	match stage:
		Stage.SEEDED:
			table.add_entry("onion_seed", 1, 1, 1.0)
		Stage.SPROUTING:
			table.add_entry("onion_seed", 1, 2, 1.0)
		Stage.GROWING:
			table.add_entry("onion_seed", 2, 4, 1.0)
		Stage.FLOWERING:
			table.add_entry("onion_seed", 1, 3, 1.0)
			table.add_entry("onion", 1, 1, 0.5)
		Stage.RIPE:
			table.add_entry("onion_seed", 1, 2, 0.8)
			table.add_entry("onion", 1, 3, 1.0)
		_:
			pass
