...
# Node References
@onready var character_body: CharacterBody2D = $Entity
@onready var sprite: AnimatedSprite2D = character_body.get_node("Sprite")
@onready var collision: CollisionShape2D = character_body.get_node("Collision")
@onready var health_bar: ProgressBar = character_body.get_node("Healthbar")
